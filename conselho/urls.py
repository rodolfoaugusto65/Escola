...
urlpatterns = [
    ...
    path("<int:pk>/preencher/", views.escolher_modo, name="preencher"),
    path("<int:pk>/preencher/geral/", views.preencher_conselho, name="preencher_geral"),
    path("<int:pk>/preencher/aluno/", views.preencher_aluno, name="preencher_aluno"),
    path("<int:pk>/painel/", views.painel_conselho, name="painel"),
